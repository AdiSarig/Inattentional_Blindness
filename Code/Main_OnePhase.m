function Main_OnePhase()
% Run one phase seperately from the others in case something fails between
% phases. Set the phase number in "Run experiment" section. Currently -
% phase 3.
% -----------------------------------------------------
