function [string,terminatorChar] = GetEchoStringModified(session, windowPtr, msg, x, y, textColor, bgColor, useKbCheck, varargin)
...
string = '';
output = [msg, ' ', string];
% output=WrapString(output,10);
    
% Write the initial message:
Screen('DrawText', windowPtr, output, x, y, textColor, bgColor);
Screen('FrameRect', windowPtr, [0 0 0 255*session.params.stimuli.stimContrast], [session.params.stimuli.pos.CTR-200 session.params.stimuli.pos.CTR+200],2);
